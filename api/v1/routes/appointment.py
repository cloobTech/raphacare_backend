...
async def get_appointment_by_id_route(appointment_id: str, storage=Depends(get_db_session), params: GetAppParams = Depends()):
    """Get appointment by id"""
    try:
        appointment = await get_appointment_by_id(appointment_id, storage, params=params)
        return appointment
